...
public class Combustivel extends JDialog {
	...
	public Combustivel() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Combustivel.class.getResource("/img/combustivel-64.png")));
		setModal(true);
		...
		btnCalcular.setIcon(new ImageIcon(Combustivel.class.getResource("/img/combustivel-64.png")));
