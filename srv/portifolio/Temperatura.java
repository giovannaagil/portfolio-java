...
public class Temperatura extends JDialog {
	...
	public Temperatura() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Temperatura.class.getResource("/img/temperatura.png")));
		setModal(true);
		setResizable(false);
		...
		btnCalcular.setIcon(new ImageIcon(Temperatura.class.getResource("/img/temperatura.png")));
