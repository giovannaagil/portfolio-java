...
public class Dado extends JDialog {
	...
	public Dado() {
		...
		setTitle("Dado");
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Dado.class.getResource("/img/dado-64.png")));
		setBounds(100, 100, 203, 318);
		getContentPane().setLayout(null);

		JButton btnLancar = new JButton("");
		btnLancar.setIcon(new ImageIcon(Dado.class.getResource("/img/dado-64.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(Dado.class.getResource("/img/dado-64.png")));
