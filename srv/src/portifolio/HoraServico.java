...
public class HoraServico extends JDialog {
	...
	public HoraServico() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(HoraServico.class.getResource("/img/horaservico.png")));
		...
		btnCalcular.setIcon(new ImageIcon(HoraServico.class.getResource("/img/horaservico.png")));
