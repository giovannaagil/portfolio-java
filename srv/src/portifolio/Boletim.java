...
public class Boletim extends JDialog {
	...
	public Boletim() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Boletim.class.getResource("/img/boletim-64.png")));
		setModal(true);
		...
		btnMedia.setIcon(new ImageIcon(Boletim.class.getResource("/img/boletim-64.png")));
