...
public class IMC extends JDialog {
	...
	public IMC() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(IMC.class.getResource("/img/balan�a.png")));
		setModal(true);
		setTitle("IMC");
		setResizable(false);
		...
		btnSalvar.setIcon(new ImageIcon(IMC.class.getResource("/img/balan�a.png")));
		...
		lblImagem.setIcon(new ImageIcon(IMC.class.getResource("/img/balan�a.png")));
